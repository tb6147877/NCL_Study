...
//
////recursion
//int calculateSqrtRecursion(const int x, int l,int r) {
//
//	if (r==1)//termination condition
//	{
//		return 1;
//	}
//
//	if (l + 1 >= r)//termination condition
//	{
//		return l;
//	}
//
...
//	}
//
//	return calculateSqrtRecursion(x, l, r);
//}
//
////Problem2==================================================
//
...
//
////Every suqare of the display
//class Unit {
//private:
//	int m_x;//x coordinate
//	int m_y;//y coordinate
//	int m_distance;//The distance from the origin
//
//
//	int calculateDistanceToCenter() {
//		//In this case, the coordinate of origin is (50,50)
...
//
//	//Draw this square on the display
...
//			for (int j = 0; j < MAP_COLUMN; j++)
//			{
//				//Compare the distance of every square, if it less than radius, it's a key square, draw it in yellow
//				if (m_units[i][j].getDistance()<MAP_RADIUS*MAP_RADIUS)
//				{
//					m_units[i][j].draw(true);
//				}
//				else {//in this condition, it's a normal square, draw it in blue
...
//
//
//	//std::cout<<calculateSqrtRecursion(20000, 0, 20000);
//}